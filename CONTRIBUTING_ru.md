...
Спасибо за ваш интерес к проекту **Amethyst**! Любая помощь в улучшении проекта **приветствуется**!

Присоединяйтесь к сообществу проекта на [GitHub](https://github.com/Atimenka/Amethyst)
...
Все задачи находятся в [**GitHub Projects**](https://github.com/Atimenka/Amethyst)

> [!WARNING]
> Если вы хотите взять задачу в работу, пожалуйста, оставьте комментарий в соответствующем [Issue](https://github.com/Atimenka/Amethyst/issues). Это необходимо, чтобы избежать дублирования работы.
>
> Также после отправки Pull Request'а, укажите соответствующий [Issue](https://github.com/Atimenka/Amethyst/issues) в описании к Pull Request'у с помощью строки `Closes #НОМЕР_ISSUE`
...
Все контрибьюторы будут навсегда добавлены **в специальное окно "Благодарности"** прямо внутри Amethyst.
